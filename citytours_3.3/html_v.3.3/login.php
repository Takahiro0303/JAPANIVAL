    	...
    	<div class="container">
        	<div class="row">
            	<div class="col-md-4 col-md-offset-4 col-sm-6 col-sm-offset-3">
                	<div id="login">
                    		<div class="text-center"><img src="img/japanival.png" alt="Image" data-retina="true" ></div>
                            <hr>
                            ...
                            <div class="login-or"><hr class="hr-or"><span class="span-or">or</span></div>
                                ...
                                <div class="form-group">
                                    <label>Email</label>
                                    <input type="text" name="email" value="<?php echo htmlspecialchars($email); ?>" class="form-control" placeholder="Email">
