    ...
    <div class="margin_60 container">      
      ...
      <div id="tabs" class="tabs">
            ...
            <div class="row">
              <div class="col-md-7 col-sm-7" name="a1">
                ...
                <ul id="profile_summary">
                  ...
                  <li>Email <span><?php echo htmlspecialchars($login_user['email']);?></span>
                  </li>
                  <li>Country <span><?php echo htmlspecialchars($login_user['nationality']);?></span>
                  </li>
                  <li>Gender <span><?php echo htmlspecialchars($login_user['gender']);?></span>
                  </li>
                  <li>Level of Japanese<span></span>
                  </li>
                  <li>Comment<span><?php echo htmlspecialchars($login_user['self_intro']);?></span>
                  </li>
                </ul>
                ...
                <table class="table table-bordered">
                  <thead>
                    <tbody>
                      ...
                      <tr>
                        <th>Username</th>
                        <td><input class="form-control" name="nickname" id="nickname" type="text" value="<?php echo htmlspecialchars($nickname);?>">
                      ...
                      <tr>
                        <th>Email</th>
                        <td><input class="form-control" name="email" id="email" type="text" value="<?php echo htmlspecialchars($email); ?>">
                       ...
                       <tr>
                        <th>Now Password</th>
                        <td><input type="password" class="form-control" name="current_password" id="password" >
                        <?php if(isset($errors['current_password']) && $errors['current_password'] == 'failed') { ?>
                        <p class="alert-danger">本人確認に失敗しました。再度パスワードを入力してください</p>
                        <?php } ?>
                        </td>
                      ...
                      <tr>
                        <th>New Password</th>
                        <td><input class="form-control" name="new_password" id="password" type="password">
                        <?php if(isset($errors['new_password']) && $errors['new_password'] == 'length') { ?>
          <p class="alert-danger">パスワードは４文字以上で入力してください</p>
        <?php } ?>
        </td>
                      </tr>
                      <tr>
                        <th>Confirm password</th>
                        <td><input class="form-control" name="confirm_password" id="password" type="password">
        ...
        <?php } ?>
                      ...
                      <tr>
                        <th>Country</th>
                        <td><select class="form-control" name="nationality" id="nationality" value="<?php echo htmlspecialchars($login_user['nationality']); ?>">
                    ...
                    <option value="Zimbabwe">Zimbabwe</option>
                      ...
                      <tr>
                        <th>Gender</th>
                        <td><select class="form-control" name="gender" id="gender" placeholder="<?php echo htmlspecialchars($login_user['']);?>">
                    ...
                    <option value="other" selected>other</option>
                      ...
                      <tr>
                        <th>Comment</th>
                        <td><textarea class="form-control" value="<?php echo htmlspecialchars($login_user['self_intro']);?>"></textarea></td>
                      </tr>
            ...
            <div class="form-inline upload_1">
              <div class="form-group">
                <input type="file" name="pic_path" id="js-upload-files" multiple>
